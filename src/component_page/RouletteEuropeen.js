      ...
      <React.Fragment>
        ...
        <div>
          ...
          <ul>
            ...
            (2 chance sur 36) soit {(2 / 36) * 100}%
          </ul>
          <ul>
            Mise sur trois numéros (transversale dite aussi « transversale
            pleine » : exemple : 7-8-9) → 11 fois la mise. {(3 / 36) * 100}%
          </ul>
          <ul>
          ...
          <ul>
            ...
            exemple : 13-14-15-16-17-18) → 5 fois la mise. {(6 / 36) * 100}%
          </ul>
          <ul>
            Mise sur douze numéros (douzaine ou colonne : exemple : colonne 1-34
            ou douzaine 1-12) → 2 fois la mise. {(12 / 36) * 100}%
          </ul>
          <ul>
            Mise sur une chance simple, soit dix-huit numéros (Noir-Rouge -
            Pair-Impair - Manque-Passe) → 1 fois la mise. {(1 / 36) * 100}%
          </ul>
          <ul>
